...
F2.writeSync(1);
 //status variables for getting status of lights aand fan//
var statL1=0;
var statL2=0;
var statL3=0;
var statF1=0;
...
var arr = []; //array to store the info of operated person//
const fs = require('fs');// node lib for wirting the files 
const readline = require('readline');
const TelegramBot = require('node-telegram-bot-api');// node lib to telegrm bot // 
const token = 'place your telegram bot API token ';
...
const {
	...
	{	
		    if (msg.chat.id in chatId)  // filtering the personals who can access the bot//

		{
			 ...
			 console.log(arr);
				...
				bot.onText(/\L1_ON/, ( msg) => {
					...
					{
						if(statL1!=1)// for knowing status and prevent malopertion
						{	
